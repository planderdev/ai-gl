...
export const metadata: Metadata = { title: "캐디스 Admin · 견적 시스템", description: "숙박·골프·차량·항공 원가와 마진을 계산해 원가표 엑셀을 만드는 여행사 업무 자동화" };
      ...
      <body className="admin-body">
        <header className="admin-header" id="adminHeader">
          <div className="admin-header__left">
            <Link href="/" className="admin-header__brand"><span className="admin-header__brand-mark">C</span><span className="admin-header__brand-text">캐디스 Admin</span></Link>
          </div>
          <div className="admin-header__right">
            <div className="admin-header__page-title">견적·원가표 시스템</div>
